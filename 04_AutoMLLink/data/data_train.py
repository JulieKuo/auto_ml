...
if __name__ == "__main__":
    ...
    try:
        ...
        redisKey_percent = redisKey + '_percent'
        ...
        try:
            ...
            platform_msg_handler.set_value(redisKey_status, 'Training')
            platform_msg_handler.set_value(redisKey+'_pid', getpid())
            
            # train
            h2o_obj = H2O_AutoMLInterface(platform_msg_handler, redisKey, log_obj)
            h2o_obj.train(filepath, arg_dict['target'], models_folderpath, int(60 * arg_dict['max_runtime_mins']))
            ...
            platform_msg_handler.set_value(redisKey_percent, 1.0)

...
class AIPlatformMessageInterface(MessageInterface):
    def __init__(self, job_id, user_id, group_id, project_id, database_config={}, redis_config={}, user=None):
        ...
        self._redis_args = {'host': '127.0.0.1', 'port': 6379, 'decode_responses': True,'health_check_interval':30}
    ...
    def set_value(self, key, value):
        ...
        try:
            ...
            print('redis set key exception')
            tempr = redis.Redis(**self._redis_args)
            self._r = tempr
            print('recoonect redis')
            self._r.set(key,value)
